...
public class Gladius {// Rotation is cw
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      for (int i = 0; i < populationSize; i++) { // make generation of 100 randoms
         gen[i] = new Gladius((int) Math.random() * 2000, (int) Math.random() * 2000, Math.random() * 360, 2000, 2000,
   ...
   void sees(Gladius glad) {
      ...
      int[] ys = new int[3];
      xs[0] = x;
      xs[1] = (int) (Math.cos((rotation / 180 * Math.PI) - Math.PI * .05) * 10000) + x;
      xs[2] = (int) (Math.cos((rotation / 180 * Math.PI) + Math.PI * .05) * 10000) + x;
      ys[0] = y;
      ys[1] = (int) (Math.sin((rotation / 180 * Math.PI) - Math.PI * .05) * 10000) + y;
      ys[2] = (int) (Math.sin((rotation / 180 * Math.PI) + Math.PI * .05) * 10000) + y;
      Polygon poly = new Polygon(xs, ys, 3);
      if (poly.contains(enemyX, enemyY) || poly.contains(enemyX-5,enemyY)|| poly.contains(enemyX-5,enemyY-5)|| poly.contains(enemyX-5,enemyY+5)|| poly.contains(enemyX,enemyY-5)|| poly.contains(enemyX,enemyY+5)|| poly.contains(enemyX+5,enemyY)|| poly.contains(enemyX+5,enemyY-5)|| poly.contains(enemyX+5,enemyY+5)) {
         fitness++;
         inCone = 1;
         relX = enemyX - x;
         relY = y - enemyY;//ill be back
      } else {
         inCone = 0;
         relX = 1000000;
         relY = 1000000;
