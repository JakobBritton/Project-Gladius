...
public class VisionCone extends Actor
{
    ...
    public void display(double rot)
    {
        ...
        int[] ys = new int[3];
        xs[0] = x;
        xs[1] = (int)(Math.cos((rot/180*Math.PI) - Math.PI * .05) * 1000)+x;
        xs[2] = (int)(Math.cos((rot/180*Math.PI) + Math.PI * .05) * 1000)+x;
        ys[0] = y;//we can try later
        ys[1] = (int)(Math.sin((rot/180*Math.PI) - Math.PI * .05) * 1000)+y;
        ys[2] = (int)(Math.sin((rot/180*Math.PI) + Math.PI * .05) * 1000)+y;
    ...
    public VisionCone()
    {
         x = 0;
         y = 0;
         img = new GreenfootImage(2100,2100);
    }
