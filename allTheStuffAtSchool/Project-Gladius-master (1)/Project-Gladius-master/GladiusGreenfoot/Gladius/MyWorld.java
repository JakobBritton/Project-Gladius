...
{0.336066 , 0.107630 , 0.041119 , 0.266461 }
        ...
        double[][] jacR = {
            {-0.385406 , 0.253441 , 0.096392 , -0.194937 , 0.435848 },
{0.399978 , -0.240646 , 0.274881 , 0.523058 , 0.517762 },
{-0.119095 , -0.105405 , 0.354628 , -0.510736 , 0.117264 }
        };
        
        double[][] jacRA = {
            {-0.117927 , 0.227906 , 0.251373 },
{0.013930 , -0.083329 , -0.556976 },
{0.324309 , 0.076977 , 0.132660 },
{0.451621 , -0.541778 , -0.199052 },
{-0.103641 , -0.111328 , 0.201787 }
            
        };
        
        jacob.setTheta(jacT1,jacT2,jacT3,jacR,jacRA);
...
{-0.103641 , -0.111328 , 0.201787 }
        ...
        james.setTheta(jamT1,jamT2,jamT3,jamR,jamRA);
    ...
    public void act()
    {
         ...
         gah++;
         //System.out.println(repeat.get());
         if(gah == 150 && scanner.hasNextLine() && !repeat.get())
         {
             gen++;
           ...
           String[][] recur = new String[3][5];
           scanner.nextLine();
           recur[0] = scanner.nextLine().split(" ");
           recur[1] = scanner.nextLine().split(" ");
           recur[2] = scanner.nextLine().split(" ");
           String[][] recurA = new String[5][3];
           scanner.nextLine();
           recurA[0] = scanner.nextLine().split(" ");
           recurA[1] = scanner.nextLine().split(" ");
           recurA[2] = scanner.nextLine().split(" ");
           recurA[3] = scanner.nextLine().split(" ");
           recurA[4] = scanner.nextLine().split(" ");
           double[][] t1 = new double[3][4];
           double[][] t2 = new double[4][4];
           double[][] t3 = new double[4][4];
           double[][] tr = new double[3][5];
           double[][] tar = new double[5][3];
           double[][] t11 = new double[3][4];
           double[][] t22 = new double[4][4];
           double[][] t33 = new double[4][4];
           double[][] tr1 = new double[3][5];
           double[][] tar1 = new double[5][3];
           scanner.nextLine();
           ...
           scanner.nextLine();
           String[][] recur1 = new String[3][5];
           recur1[0] = scanner.nextLine().split(" ");
           recur1[1] = scanner.nextLine().split(" ");
           recur1[2] = scanner.nextLine().split(" ");
           scanner.nextLine();
           String[][] recurA1 = new String[5][3];
           recurA1[0] = scanner.nextLine().split(" ");
           recurA1[1] = scanner.nextLine().split(" ");
           recurA1[2] = scanner.nextLine().split(" ");
           recurA1[3] = scanner.nextLine().split(" ");
           recurA1[4] = scanner.nextLine().split(" ");
           scanner.nextLine();
           for(int r = 0; r < 3; r++)
           {
               for(int c = 0; c < 4; c++)
           ...
           for(int r = 0; r < 5; r++)
           {
               for(int c = 0; c < 3; c++)
               {
                   tr[c][r] = Double.parseDouble(recur[c][r]);
                   tr1[c][r] = Double.parseDouble(recur1[c][r]);
                   tar[r][c] = Double.parseDouble(recurA[r][c]);
                   tar1[r][c] = Double.parseDouble(recurA1[r][c]);
               }
            }
           jacob.setTheta(t1,t2,t3,tr,tar);
           james.setTheta(t11,t22,t33,tr1,tar1);
         }
         else if(gah == 150)
         {
             gah = 0;
