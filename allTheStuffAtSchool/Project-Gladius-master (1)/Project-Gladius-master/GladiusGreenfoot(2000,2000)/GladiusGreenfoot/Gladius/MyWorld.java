...
{0.336066 , 0.107630 , 0.041119 , 0.266461 }
        ...
        jacob.setRotation(Greenfoot.getRandomNumber(360));
...
{-0.264782 , 0.500761 , 0.336408 , -0.129507 }
        ...
        james.setRotation(Greenfoot.getRandomNumber(360));
        jacob.setColor(new Color(0,255,255));
        james.setColor(new Color(0,255,0));
        int jamesx = Greenfoot.getRandomNumber(2000)+50;
        int jamesy = Greenfoot.getRandomNumber(2000)+50;
        int jacx = Greenfoot.getRandomNumber(2000)+50;
        int jacy = Greenfoot.getRandomNumber(2000)+50;
        addObject(james,jamesx,jamesy);
        addObject(jacob,jacx,jacy);
        addObject(jamesVision,1050,1050);
        addObject(jacobVision,1050,1050);
    ...
    public void act()
    {
         ...
         gah++;
         if(gah == 400 && scanner.hasNextLine())
         {
             gen++;
