...
public class Gladius extends Actor
{
    ...
    public boolean sees(Gladius enemy)
    {
      ...
      xs[0] = getX();
      xs[1] = (int) (Math.cos((rotation/ 180 * Math.PI) - Math.PI * .05) * 10000) + getX();
      xs[2] = (int) (Math.cos((rotation / 180 * Math.PI) + Math.PI * .05) * 10000) + getX();
      ys[0] = getY();
      ys[1] = (int) (Math.sin((rotation / 180 * Math.PI) - Math.PI * .05) * 10000) + getY();
      ys[2] = (int) (Math.sin((rotation / 180 * Math.PI) + Math.PI * .05) * 10000) + getY();
      Polygon poly = new Polygon(xs, ys, 3);
      vc.display(getRotation());
      return (poly.contains(enemyX, enemyY) || poly.contains(enemyX-5,enemyY)|| poly.contains(enemyX-5,enemyY-5)|| poly.contains(enemyX-5,enemyY+5)|| poly.contains(enemyX,enemyY-5)|| poly.contains(enemyX,enemyY+5)|| poly.contains(enemyX+5,enemyY)|| poly.contains(enemyX+5,enemyY-5)|| poly.contains(enemyX+5,enemyY+5)) ;
 
        //int x = enemy.getX();
        //int relX = Math.abs(x-getX());
        //int y = enemy.getY();
        //int relY = Math.abs(y-getX());
        
        
        
        //System.out.println(enemy.getX() + " " + enemy.getY());
        //System.out.println(vc.img.getColorAt(x,y).toString());     
        //return vc.img.getColorAt(x,y).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x-5,y).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x-5,y-5).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x-5,y+5).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x,y-5).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x,y+5).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x+5,y).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x+5,y-5).equals(new Color(0,0,0,1)) || vc.img.getColorAt(x+5,y+5).equals(new Color(0,0,0,1));
